...
#ifndef _BATTERYCONFIG_h
#define _BATTERYCONFIG_h
...
public:
    ...
    tN2kBatType Type() { return (tN2kBatType)atoi(_BatTypeValue); };
    tN2kBatNomVolt NomVolt() { return (tN2kBatNomVolt)atoi(_BatNomVoltValue); };
    tN2kBatChem Chemistry() { return (tN2kBatChem)atoi(_BatChemValue); };
    uint16_t Capacity_Ah() { return (uint16_t)atoi(_battCapacityValue); };
    ...
    const char* ReplacmentDate() { return _BatteryReplacmentDateValue; };
    const char* ReplacmentTime() { return _BatteryReplacmentTimeValue; };
    const char* Manufacturer() { return _BatteryManufacturerValue; };
